...
**Then** a calm, line-oriented launchpad opens led by "Analyze this repository (cwd)", then "Analyze a remote repository", **"Settings"**, "Doctor", and "Help",
