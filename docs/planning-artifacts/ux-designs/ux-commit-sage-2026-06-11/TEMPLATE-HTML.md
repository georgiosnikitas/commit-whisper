---
title: commit-sage TEMPLATE-HTML
status: draft
created: 2026-06-12
updated: 2026-06-13
---

commit-sage TEMPLATE-HTML
=========================
...
```
① MASTHEAD        commit-sage · <repo> · <branch> · <N> commits · <contributors>
...
⑦ FOOTER          Generated by commit-sage vX · schemaVersion 1.0.0 ·
...
`Generated by commit-sage v<version> · schemaVersion 1.0.0 · <provider>/<model> ·
...
```
  ...
  commit-sage · payments-api                 (masthead — no Confidence pill)
  main · 1,204 commits · 87 contributors · analyzed 2026-06-12
