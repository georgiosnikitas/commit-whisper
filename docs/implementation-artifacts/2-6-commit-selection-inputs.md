...
- [Source: docs/planning-artifacts/prds/prd-commit-whisper-2026-06-06/prd.md#FR-1] (commit-selection inputs) · [Source: …#FR-4 Consequences] (selection changes which commits feed the metrics; no-merges changes A–F; timezone governs bucketing)
